        ...
        <div class="container">
            <div class="row">
              ...
              />
                            ...
                            <span class="cel-temperature" *ngIf="content">{{content.wather[1]}}</span>
                        </li>
                        <li><span class="time-now" *ngIf="content">{{content.title}}: {{content.currency}}</span></li>
