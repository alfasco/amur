/*1480591571,,JIT Construction: v2713135,en_US*/
...
function instagram() {
	try {
				...
				with(this) {
					...
					__d('keyMirror', ['invariant'], function a(b, c, d, e, f, g, h) {
						...
						var i = function j(k) {
							var l = {},
								m;
							!(k instanceof Object && !ES('Array', 'isArray', false, k)) ? h(0): void 0;
							for (m in k) {
					...
					__d('ig.sdk.Embeds', ['CSS', 'DOMEventListener', 'sdk.domReady', 'IGIframeableMessageTypes', 'invariant', 'isNumberLike'], function a(b, c, d, e, f, g, h, i, j, k, l, m) {
						...
						function ta(wa) {
							...
							switch (db) {
								...
								case k.LOADING:
									qa(function(hb) {
										if (ma[ya]) ma[ya].contentLoading = hb;
									});
									break;
								case k.MEASURE:
									var gb = cb.height;
		...
		new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2713135","namespace":"instgrm","message":"' + e.message + '"}}');
	}
}
